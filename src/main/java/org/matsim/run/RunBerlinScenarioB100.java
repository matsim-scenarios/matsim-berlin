...
public final class RunBerlinScenarioB100 {

	private static final Logger log = Logger.getLogger(RunBerlinScenarioB100.class );
	...
	public static void main(String[] args) {
		...
		if ( args.length==0 ) {
			args = new String[] {"scenarios/berlin-v5.5-1pct/input/berlin-v5.5-10pct.config_ScenarioB100.xml"}  ;
		}
