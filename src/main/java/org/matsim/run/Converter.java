...
public class Converter {
	...
	public static void main(String[] args) {
		...
		config.plans().setInputFile("https://svn.vsp.tu-berlin.de/repos/public-svn/matsim/scenarios/countries/de/berlin/berlin-v6.4/input/berlin-v6.4-1pct.plans.xml.gz");
	...
	private static int getFacilityId(Person person) {
