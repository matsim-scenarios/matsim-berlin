 ...
 */
final class OpenBerlinIntermodalPtDrtAndSharingRouterModeIdentifier implements AnalysisMainModeIdentifier {
	...
	private final Logger log = LogManager.getLogger(OpenBerlinIntermodalPtDrtAndSharingRouterModeIdentifier.class);

	@Inject
    OpenBerlinIntermodalPtDrtAndSharingRouterModeIdentifier() {
