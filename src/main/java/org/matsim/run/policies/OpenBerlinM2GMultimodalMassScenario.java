...
//	this is the "scaled" bike speed after analyzing elasticities of bike speed and bike modal share
	...
	@CommandLine.Option(names = "--berlin-shp", description = "Path to shp file for adaption of link capacities and freespeeds. Should be shape of berlin or related.", required = true)
...
//		no changes in controller compared to base case
//		3) drt
//		the following changes are: DRT with pooling and drt fare of 3Eu = pt fare
