...
public final class RunBerlinScenarioC100test {

	private static final Logger log = Logger.getLogger(RunBerlinScenarioC100test.class );
	...
	public static void main(String[] args) {
		...
		if ( args.length==0 ) {
			args = new String[] {"scenarios/berlin-v5.5-1pct/input/berlin-v5.5-1pct.config_ScenarioC100.xml"}  ;
		}
