...
public final class RunBerlinScenarioA75 {

    private static final Logger log = Logger.getLogger(RunBerlinScenarioA75.class );
    ...
    public static void main(String[] args) {
        ...
        if ( args.length==0 ) {
            args = new String[] {"scenarios/berlin-v5.5-10pct/input/berlin-v5.5-10pct.config_ScenarioA75.xml"}  ;
        }
