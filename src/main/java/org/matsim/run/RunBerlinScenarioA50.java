...
public final class RunBerlinScenarioA50 {

    private static final Logger log = Logger.getLogger(RunBerlinScenarioA50.class );
    ...
    public static void main(String[] args) {
        ...
        if ( args.length==0 ) {
            args = new String[] {"scenarios/berlin-v5.5-10pct/input/berlin-v5.5-10pct.config_ScenarioA50.xml"}  ;
        }
