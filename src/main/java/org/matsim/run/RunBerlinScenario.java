...
public final class RunBerlinScenario {
	...
	public static Controler prepareControler( Scenario scenario ) {
		...
		// use a main mode identifier which knows how to handle legs generated by the used sbb pt raptor router
		controler.addOverridingModule(new AbstractModule() {		
			@Override
			public void install() {
				bind(MainModeIdentifier.class).to(BerlinMainModeIdentifier.class).asEagerSingleton();
			}
		});
