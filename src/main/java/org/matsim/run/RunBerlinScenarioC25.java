...
public final class RunBerlinScenarioC25 {

	private static final Logger log = Logger.getLogger(RunBerlinScenarioC25.class );
	...
	public static void main(String[] args) {
		...
		if ( args.length==0 ) {
			args = new String[] {"scenarios/berlin-v5.5-10pct/input/berlin-v5.5-10pct.config_ScenarioC25.xml"}  ;
		}
