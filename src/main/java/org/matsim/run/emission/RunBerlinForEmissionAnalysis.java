package org.matsim.run.emission;
...
//"dumped person xyz" Meldung
//2021-08-16T11:47:59,944 ERROR SimStepParallelEventsManagerImpl$ExceptionHandler:420 Thread class org.matsim.core.events.SimStepParallelEventsManagerImpl$ProcessEventsRunnable0 died with exception while handling events.

import static org.matsim.core.config.groups.ControlerConfigGroup.RoutingAlgorithmType.FastAStarLandmarks;
public class RunBerlinForEmissionAnalysis {
    private static final Logger log = Logger.getLogger(RunBerlinForEmissionAnalysis.class );
    ...
    public static void main(String[] args) {
        ...
        if ( args.length==0 ) {
            args = new String[] {"C:\\Users\\anton\\OneDrive\\uni\\MATSim\\tests\\output\\config_with_simple_emissions.xml"}  ;
        }
