...
public final class RunBerlinScenarioB50 {

	private static final Logger log = Logger.getLogger(RunBerlinScenarioB50.class );
	...
	public static void main(String[] args) {
		...
		if ( args.length==0 ) {
			args = new String[] {"scenarios/berlin-v5.5-10pct/input/berlin-v5.5-10pct.config_ScenarioB50.xml"}  ;
		}
