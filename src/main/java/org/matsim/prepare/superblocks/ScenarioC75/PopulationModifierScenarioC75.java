...
public class PopulationModifierScenarioC75 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String plansOutputFile = "/Users/moritzkreuschner/Desktop/Master Thesis/B_Coding/Coding/git/plans-modified-carSuperblocks75.xml.gz";
        ...
        for (int i = 1; i < 160; i++) {
            ...
            BufferedWriter bw = new BufferedWriter(new FileWriter("/Users/moritzkreuschner//Desktop/Master Thesis/B_Coding/Coding/git/POPULATIONS/75percent/personIDsList_Superblock" + i + ".txt"));
