...
import org.matsim.prepare.superblocks.ScenarioC100.RunBerlinScenarioWithSuperblockPop_C100;
...
public class RunBerlinScenario_B100 {

    private static final Logger log = Logger.getLogger(RunBerlinScenario_B100.class );
