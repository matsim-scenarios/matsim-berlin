...
public class NetworkModifierScenarioB50 {

    private static final Logger LOG = Logger.getLogger(org.matsim.prepare.superblocks.ScenarioB50.NetworkModifierScenarioB50.class);
    ...
    public static void main(String[] args) throws IOException {
        ...
        String networkOutputFile = "/Users/moritzkreuschner/Desktop/Master Thesis/B_Coding/Coding/git/matsim-berlin-kreuschner/superblock_input_data/Input_B50/Network/Network-modifiedB50.xml.gz";

        Path filePath = Paths.get("/Users/moritzkreuschner/Desktop/Master Thesis/E_Shapefiles/Shapefiles/Superblocks_Shapefiles/50percent/NOTin50percent.txt");
        ...
        for (int i = 1; i < 160; i++) {
            ...
            LOG.info("Finished modifying car mode");
