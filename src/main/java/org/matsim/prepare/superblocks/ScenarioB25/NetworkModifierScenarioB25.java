...
public class NetworkModifierScenarioB25 {


    private static final Logger LOG = Logger.getLogger(org.matsim.prepare.superblocks.ScenarioB25.NetworkModifierScenarioB25.class);
    ...
    public static void main(String[] args) throws IOException {
        ...
        List<Integer> NOTin25list = Files.lines(Paths.get("/Users/moritzkreuschner/Desktop/Master Thesis/E_Shapefiles/Shapefiles/Superblocks_Shapefiles/50percent/NOTin50percent.txt"))
