...
public class RunOfflineNoiseAnalysis_C100 {

    private static final Logger log = Logger.getLogger(RunOfflineNoiseAnalysis_C100.class);
    ...
    public RunOfflineNoiseAnalysis_C100(String runDirectory, String runId, String analysisOutputDirectory) {
    ...
    public static void main(String[] args) {
       ...
       // final String runId = "berlin-v5.4-1pct";
        ...
        RunOfflineNoiseAnalysis_C100 analysis = new RunOfflineNoiseAnalysis_C100(runDirectory, runId, "./scenario/");
        analysis.run();
    }
