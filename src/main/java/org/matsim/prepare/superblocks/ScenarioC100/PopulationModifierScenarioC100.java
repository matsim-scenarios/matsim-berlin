...
public class PopulationModifierScenarioC100 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String plansOutputFile = "/Users/moritzkreuschner/Desktop/Master Thesis/B_Coding/Coding/git/plans-modified-carSuperblocks100.xml.gz";
        ...
        for (Person person : scenario.getPopulation().getPersons().values()) {
            ...
            if (areaGeometry.contains(homeActAsPoint)&&(!person.getId().toString().contains("freight"))) {
                ...
                person.getAttributes().putAttribute("subpopulation"+i, "personSuperblock"+i);
                ...
                for (PlanElement pe : person.getPlans().get(0).getPlanElements()) {
                    if (pe instanceof Leg) {
                        ...
                        if (leg.getMode().equals(TransportMode.car)) {
                            leg.setMode("carSuperblock" + i);
                            leg.getAttributes().putAttribute("routingMode", "carSuperblock" + i);
                        }
        ...
        BufferedWriter bw = new BufferedWriter(new FileWriter("/Users/moritzkreuschner//Desktop/Master Thesis/B_Coding/Coding/git/POPULATIONS/100percent/personIDsList_Superblock" + i + ".txt"));
