 ...
 */
public final class BicycleTrafficStatsCalculator {
	...
	private final Vehicle bikeVehicle;


	public BicycleTrafficStatsCalculator(Network network, TravelTime travelTime, VolumesAnalyzer volumesAnalyzer, int timeSlice) {
		this.network = network;
		this.travelTime = travelTime;
		this.volumesAnalyzer = volumesAnalyzer;
		this.timeSlice = timeSlice;
		this.bikeVehicle = null;
	}

	public BicycleTrafficStatsCalculator(Network network, TravelTime travelTime, VolumesAnalyzer volumesAnalyzer, int timeSlice, Vehicle bikeVehicle) {
		this.network = network;
		this.travelTime = travelTime;
		this.volumesAnalyzer = volumesAnalyzer;
		this.timeSlice = timeSlice;
		this.bikeVehicle = bikeVehicle;
	}
	...
	public double getAvgSpeed(Link link, int startTime, int endTime) {
		...
		for (int time = startTime; time < endTime; time += timeSlice) {
			...
			double seconds = this.travelTime.getLinkTravelTime(link, time, null, bikeVehicle);
