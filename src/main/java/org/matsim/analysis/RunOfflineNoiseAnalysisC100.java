 ...
 *
 */
public class RunOfflineNoiseAnalysisC100 {
	private static final Logger log = Logger.getLogger(RunOfflineNoiseAnalysisC100.class);
...
//	private final String noiseBarriersFile = "https://svn.vsp.tu-berlin.de/repos/public-svn/matsim/scenarios/countries/de/berlin/berlin-v5.5-10pct/input/berlin-buildings/osm-buildings-dissolved.geojson";
	...
	public RunOfflineNoiseAnalysisC100(String runDirectory, String runId, String analysisOutputDirectory) {
	...
	public static void main(String[] args) {
		...
		RunOfflineNoiseAnalysisC100 analysis = new RunOfflineNoiseAnalysisC100(runDirectory, runId, "./scenario/");
		analysis.run();
	}
