...
public class TripAnalysisNoModeShift implements MATSimAppCommand {
	...
	private static final Logger log = LogManager.getLogger(TripAnalysisNoModeShift.class);
	...
	@CommandLine.Mixin
	private InputOptions input = InputOptions.ofCommand(TripAnalysisNoModeShift.class);
	@CommandLine.Mixin
	private OutputOptions output = OutputOptions.ofCommand(TripAnalysisNoModeShift.class);
	...
	public static void main(String[] args) {
		new org.matsim.application.analysis.population.TripAnalysis().execute(args);
	}
