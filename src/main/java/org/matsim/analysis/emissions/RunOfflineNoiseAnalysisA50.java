 ...
 *
 */
public class RunOfflineNoiseAnalysisA50 {
	private static final Logger log = Logger.getLogger(RunOfflineNoiseAnalysisA50.class);
...
//	private final String noiseBarriersFile = "https://svn.vsp.tu-berlin.de/repos/public-svn/matsim/scenarios/countries/de/berlin/berlin-v5.5-10pct/input/berlin-buildings/osm-buildings-dissolved.geojson";
	...
	public RunOfflineNoiseAnalysisA50(String runDirectory, String runId, String analysisOutputDirectory) {
	...
	public static void main(String[] args) {
		...
		RunOfflineNoiseAnalysisA50 analysis = new RunOfflineNoiseAnalysisA50(runDirectory, runId, "./scenario/C50/");
		analysis.run();
	}
