...
public class RunOfflineAirPollutionAnalysisA100 {
    private static final Logger log = Logger.getLogger(RunOfflineAirPollutionAnalysisA100.class);
    ...
    public RunOfflineAirPollutionAnalysisA100(String runDirectory, String runId, String hbefaFileWarm, String hbefaFileCold, String analysisOutputDirectory) {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String runDirectory = "/net/ils/kreuschner/output/output_ScenarioC100/";
        RunOfflineAirPollutionAnalysisA100 analysis = new RunOfflineAirPollutionAnalysisA100(
                runDirectory,
                runId,
                hbefaFileWarm,
                hbefaFileCold,
