 ...
 *
 */
public class RunOfflineNoiseAnalysisB25 {
	private static final Logger log = Logger.getLogger(RunOfflineNoiseAnalysisB25.class);
...
//	private final String noiseBarriersFile = "https://svn.vsp.tu-berlin.de/repos/public-svn/matsim/scenarios/countries/de/berlin/berlin-v5.5-10pct/input/berlin-buildings/osm-buildings-dissolved.geojson";
	...
	public RunOfflineNoiseAnalysisB25(String runDirectory, String runId, String analysisOutputDirectory) {
	...
	public static void main(String[] args) {
		...
		RunOfflineNoiseAnalysisB25 analysis = new RunOfflineNoiseAnalysisB25(runDirectory, runId, "./scenario/A25/");
		analysis.run();
	}
