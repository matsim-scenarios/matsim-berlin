 ...
 *
 */
public class RunOfflineNoiseAnalysisB75 {
	private static final Logger log = Logger.getLogger(RunOfflineNoiseAnalysisB75.class);
...
//	private final String noiseBarriersFile = "https://svn.vsp.tu-berlin.de/repos/public-svn/matsim/scenarios/countries/de/berlin/berlin-v5.5-10pct/input/berlin-buildings/osm-buildings-dissolved.geojson";
	...
	public RunOfflineNoiseAnalysisB75(String runDirectory, String runId, String analysisOutputDirectory) {
	...
	public static void main(String[] args) {
		...
		RunOfflineNoiseAnalysisB75 analysis = new RunOfflineNoiseAnalysisB75(runDirectory, runId, "./scenario/A75/");
		analysis.run();
	}
