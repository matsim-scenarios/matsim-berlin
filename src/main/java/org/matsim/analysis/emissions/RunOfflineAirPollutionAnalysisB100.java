...
public class RunOfflineAirPollutionAnalysisB100 {
    private static final Logger log = Logger.getLogger(RunOfflineAirPollutionAnalysisB100.class);
    ...
    public RunOfflineAirPollutionAnalysisB100(String runDirectory, String runId, String hbefaFileWarm, String hbefaFileCold, String analysisOutputDirectory) {
    ...
    public static void main(String[] args) throws IOException {
        ...
        final String runId = "ScenarioA100" ;
        String runDirectory = "/net/ils/kreuschner/output/output_ScenarioA100/";
        RunOfflineAirPollutionAnalysisB100 analysis = new RunOfflineAirPollutionAnalysisB100(
                runDirectory,
                runId,
                hbefaFileWarm,
                hbefaFileCold,
