 ...
 *
 */
public class RunOfflineNoiseAnalysisB50 {
	private static final Logger log = Logger.getLogger(RunOfflineNoiseAnalysisB50.class);
...
//	private final String noiseBarriersFile = "https://svn.vsp.tu-berlin.de/repos/public-svn/matsim/scenarios/countries/de/berlin/berlin-v5.5-10pct/input/berlin-buildings/osm-buildings-dissolved.geojson";
	...
	public RunOfflineNoiseAnalysisB50(String runDirectory, String runId, String analysisOutputDirectory) {
	...
	public static void main(String[] args) {
		...
		RunOfflineNoiseAnalysisB50 analysis = new RunOfflineNoiseAnalysisB50(runDirectory, runId, "./scenario/A50/");
		analysis.run();
	}
