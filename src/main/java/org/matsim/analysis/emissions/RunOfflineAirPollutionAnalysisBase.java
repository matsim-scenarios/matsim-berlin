...
public class RunOfflineAirPollutionAnalysisBase {
    private static final Logger log = Logger.getLogger(RunOfflineAirPollutionAnalysisBase.class);
    ...
    public RunOfflineAirPollutionAnalysisBase(String runDirectory, String runId, String hbefaFileWarm, String hbefaFileCold, String analysisOutputDirectory) {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String runDirectory = "https://svn.vsp.tu-berlin.de/repos/public-svn/matsim/scenarios/countries/de/berlin/berlin-v5.5-10pct/output-berlinv5.5/";
        RunOfflineAirPollutionAnalysisBase analysis = new RunOfflineAirPollutionAnalysisBase(
                runDirectory,
                runId,
                hbefaFileWarm,
                hbefaFileCold,
                "/net/ils/kreuschner/output/output_Base/emission-analysis-hbefa-v4.1-2020");
        try {
            analysis.run();
        } catch (IOException e) {
            e.printStackTrace();
