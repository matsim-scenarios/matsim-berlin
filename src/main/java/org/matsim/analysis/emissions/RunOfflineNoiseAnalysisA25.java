 ...
 *
 */
public class RunOfflineNoiseAnalysisA25 {
	private static final Logger log = Logger.getLogger(RunOfflineNoiseAnalysisA25.class);
...
//	private final String noiseBarriersFile = "https://svn.vsp.tu-berlin.de/repos/public-svn/matsim/scenarios/countries/de/berlin/berlin-v5.5-10pct/input/berlin-buildings/osm-buildings-dissolved.geojson";
	...
	public RunOfflineNoiseAnalysisA25(String runDirectory, String runId, String analysisOutputDirectory) {
	...
	public static void main(String[] args) {
		...
		RunOfflineNoiseAnalysisA25 analysis = new RunOfflineNoiseAnalysisA25(runDirectory, runId, "./scenario/C25/");
		analysis.run();
	}
