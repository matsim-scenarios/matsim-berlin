 ...
 *
 */
public class RunOfflineNoiseAnalysisB100 {
	private static final Logger log = Logger.getLogger(RunOfflineNoiseAnalysisB100.class);
...
//	private final String noiseBarriersFile = "https://svn.vsp.tu-berlin.de/repos/public-svn/matsim/scenarios/countries/de/berlin/berlin-v5.5-10pct/input/berlin-buildings/osm-buildings-dissolved.geojson";
	...
	public RunOfflineNoiseAnalysisB100(String runDirectory, String runId, String analysisOutputDirectory) {
	...
	public static void main(String[] args) {
		...
		final String runDirectory = "//net/ils/kreuschner/output/output_ScenarioA100/";
		final String runId = "ScenarioA100";
		
		RunOfflineNoiseAnalysisB100 analysis = new RunOfflineNoiseAnalysisB100(runDirectory, runId, "./scenario/A100/");
		analysis.run();
	}
