...
import playground.vsp.pt.transitRouteTrimmer.TransitRouteTrimmer;
import playground.vsp.pt.transitRouteTrimmer.TransitRouteTrimmerUtils;
...
public class RunTransitRouteTrimmerBerlin {
    ...
    public static void main(String[] args) throws IOException, SchemaException {
        ...
        final String zoneShpFile = "/home/gregor/Projekte/vw/drtSubstitutesPT/Potentialgebiet_Friedrichshagen-Ruedersdorf-Erkner/shapefile-wgs84/polygons.shp";
//        final String zoneShpFile = "/home/gregor/Projekte/vw/drtSubstitutesPT/Potentialgebiet_Stahnsdorf-Grunewald-Wannsee/shapefile-wgs84/polygons.shp";

        final String shapeFileCRS = "EPSG:4326";
        String outputPath = "Potentialgebiet_Friedrichshagen-Ruedersdorf-Erkner/";
//        String outputPath = "Potentialgebiet_Stahnsdorf-Grunewald-Wannsee/";
        ...
        TransitRouteTrimmerUtils.transitSchedule2ShapeFile(scenario.getTransitSchedule(), outputPath + "original-transitRoutes.shp", scenarioCRS.substring(scenarioCRS.lastIndexOf(":") + 1));
