...
public class PersonInBerlin {
private static final Logger log =Logger.getLogger(PersonInBerlin.class);
...
public static void main(String[] args) throws IOException {
        ...
        String outputFile = "/net/ils/kreuschner/personInsideBerlin.csv";
        final String shapeFile = "https://svn.vsp.tu-berlin.de/repos/public-svn/matsim/scenarios/countries/de/berlin/berlin-v5.5-10pct/input/berlin-shp/berlin.shp";

        PersonInBerlin generatePersonHomeLocation = new PersonInBerlin(plansFile, shapeFile);
    ...
    public PersonInBerlin(String plansFile, String shapeFile) {
