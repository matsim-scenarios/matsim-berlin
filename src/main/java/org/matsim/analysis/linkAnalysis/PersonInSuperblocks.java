...
public class PersonInSuperblocks {
private static final Logger log =Logger.getLogger(PersonInSuperblocks.class);
...
public static void main(String[] args) throws IOException {
        ...
        String outputFile = "/net/ils/kreuschner/personInsideSuperblocks_total.csv";
        final String shapeFile = "/net/ils/kreuschner/Shapefiles/Superblocks_Shapefiles/Superblocks_gesamt.shp";

        PersonInSuperblocks generatePersonHomeLocation = new PersonInSuperblocks(plansFile, shapeFile);
    ...
    public PersonInSuperblocks(String plansFile, String shapeFile) {
