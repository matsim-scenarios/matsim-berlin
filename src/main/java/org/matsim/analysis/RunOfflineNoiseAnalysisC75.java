 ...
 *
 */
public class RunOfflineNoiseAnalysisC75 {
	private static final Logger log = Logger.getLogger(RunOfflineNoiseAnalysisC75.class);
...
//	private final String noiseBarriersFile = "https://svn.vsp.tu-berlin.de/repos/public-svn/matsim/scenarios/countries/de/berlin/berlin-v5.5-10pct/input/berlin-buildings/osm-buildings-dissolved.geojson";
	...
	public RunOfflineNoiseAnalysisC75(String runDirectory, String runId, String analysisOutputDirectory) {
	...
	public static void main(String[] args) {
		...
		RunOfflineNoiseAnalysisC75 analysis = new RunOfflineNoiseAnalysisC75(runDirectory, runId, "./scenario/");
		analysis.run();
	}
