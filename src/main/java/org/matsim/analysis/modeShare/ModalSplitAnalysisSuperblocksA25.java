...
public class ModalSplitAnalysisSuperblocksA25 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        // PlanC25
        //String InputFile_planFile = "/Users/moritzkreuschner/Desktop/Master Thesis/04_Planfiles/ScenarioC25.output_plans.xml";
        ...
        //——————Input——————
        String Superblocks = "//net/ils/kreuschner/analysis/A25/ModifiedLinksInSuperblocks25.txt";
        //——————Input——————
