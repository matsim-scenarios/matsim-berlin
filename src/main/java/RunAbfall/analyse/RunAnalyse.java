...
public class RunAnalyse {
            ...
            for (ScheduledTour scheduledTour : tours) {
                ...
                for (Tour.TourElement element : elements) {
                    if (element instanceof Tour.Pickup) {
                        ...
                        wasteCollectedTons = wasteCollectedTons + (shipmentSizes.get(pickupShipmentId));
                    }
    ...
    void writeOutput(String directory, Map<Id<Person>, Double> personId2tourDistanceKm, Map<Id<Person>, Integer> personId2tourNumCollections, Map<Id<Person>, Double> personId2tourWasteCollectedTons){
        FileWriter writer;
        File file;
